...
out=/nlustre/users/chrisl/microplastics/data/55_Spades
forward=/nlustre/users/chrisl/microplastics/data/testMAG/55_R1.fastq.gz
reverse=/nlustre/users/chrisl/microplastics/data/testMAG/55_R2.fastq.gz
