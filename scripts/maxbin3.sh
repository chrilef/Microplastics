...
out=/nlustre/users/chrisl/microplastics/data/maxbin_out/59_maxbin
...
run_MaxBin.pl -contig 59_contigs.fasta -reads /nlustre/users/chrisl/microplastics/data/fastp/reads/$forward -reads2 /nlustre/users/chrisl/microplastics/data/fastp/reads/$reverse -out $out -thread 28
