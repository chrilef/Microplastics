...
out=/nlustre/users/chrisl/microplastics/data/59_Spades
forward=/nlustre/users/chrisl/microplastics/data/testMAG/59_R1.fastq.gz
reverse=/nlustre/users/chrisl/microplastics/data/testMAG/59_R2.fastq.gz    
