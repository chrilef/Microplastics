...
out=/nlustre/users/chrisl/microplastics/data/maxbin_out/55_maxbin
...
run_MaxBin.pl -contig 55_contigs.fasta -reads /nlustre/users/chrisl/microplastics/data/fastp/reads/$forward -reads2 /nlustre/users/chrisl/microplastics/data/fastp/reads/$reverse -out $out -thread 28
